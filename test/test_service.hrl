...
%% generated by soap:wsdl2erlang. Included in the repository becase it is 
...
-define(INTERFACE, {interface,"test_service",test_service,'1.1',
                    ...
                    "http://localhost:8080","test_port","test_port_binding",
                    "test_port_type",
                    [{op,"do_test",do_test,"do_test",request_response,
                      request_body,response_body,undefined}],
                    {model,
