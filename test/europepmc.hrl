...
%% This file was generated by erlang2wsdl, but it is included here because it is 
...
-define(INTERFACE, {interface,"WSCitationImplService",europepmc,'1.1',
                    soap_client_ibrowse,soap_server_cowboy_2,europepmc_server,
                    europepmc_client,[],
                    ...
                    [{op,"searchPublications",searchPublications,[],
                      request_response,searchPublications,
                      searchPublicationsResponse,undefined},
                     {op,"profilePublications",profilePublications,[],
                      request_response,profilePublications,
                      profilePublicationsResponse,undefined},
                     {op,"getCitations",getCitations,[],request_response,
                      getCitations,getCitationsResponse,undefined},
                     {op,"getReferences",getReferences,[],request_response,
                      getReferences,getReferencesResponse,undefined},
                     {op,"getTextMinedTerms",getTextMinedTerms,[],
                      request_response,getTextMinedTerms,
                      getTextMinedTermsResponse,undefined},
                     {op,"getDatabaseLinks",getDatabaseLinks,[],
                      request_response,getDatabaseLinks,
                      getDatabaseLinksResponse,undefined},
                     {op,"getSupplementaryFiles",getSupplementaryFiles,[],
                      request_response,getSupplementaryFiles,
                      getSupplementaryFilesResponse,undefined},
                     {op,"getFulltextXML",getFulltextXML,[],request_response,
                      getFulltextXML,getFulltextXMLResponse,undefined},
                     {op,"getBookXML",getBookXML,[],request_response,
                      getBookXML,getBookXMLResponse,undefined},
                     {op,"listSearchFields",listSearchFields,[],
                      request_response,listSearchFields,
                      listSearchFieldsResponse,undefined},
                     {op,"getLabsLinks",getLabsLinks,[],request_response,
                      getLabsLinks,getLabsLinksResponse,undefined}],
                    {model,
